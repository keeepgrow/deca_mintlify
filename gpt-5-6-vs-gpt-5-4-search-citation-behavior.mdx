...
**Brown Seo**, Founding Engineer (AI & Infrastructure) · Last updated: 07.31.2026
...
![Line chart: site: operator share of ChatGPT fan-out queries in DecaGEO's weekly panel rises from 33.8% and 38.2% on GPT-5.4 to 90.5% and 91.0% on GPT-5.6 Terra, with the jump at the July 25, 2026 model boundary.](/images/gpt-5-6-vs-gpt-5-4-search-citation-behavior/chart-1-site-share.png)
...
![Dumbbell chart comparing average site: share per category: nine software categories rise from 20–43% on GPT-5.4 to 88–96% on GPT-5.6 Terra, while the GEO category rises only to about 70%, the lowest lock-in.](/images/gpt-5-6-vs-gpt-5-4-search-citation-behavior/chart-2-categories.png)
*Chart: DecaGEO retrieval logs, OpenAI API, US, weeks of Jul 11–Aug 1, 2026.*
...
![Two-line chart: vendor-owned share of citations stays flat near 95% across the model change, while the share of citations arriving via a site:-targeted query jumps from 25.7% to 87.7% and replicates at 87.2%.](/images/gpt-5-6-vs-gpt-5-4-search-citation-behavior/chart-3-destination-route.png)
